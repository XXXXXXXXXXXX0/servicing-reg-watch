...
| 2024-29292 | CFPB Reg V ANPR: identity theft and coerced debt | Relevant, 0.75, proposed_rule | Not relevant | ACTION line: "Advance notice of proposed rulemaking." The v1 rationale confirms there is no proposed text. ANPRs without proposed text are not relevant. **Resolved by human review:** closed as not relevant; on the STATUS.md watch list (REVIEW_LOG). |
